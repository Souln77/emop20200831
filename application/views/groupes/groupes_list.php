    ...
    <body>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('groupes'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				...
				echo ' | '; 
				echo anchor(site_url('groupes/delete/'.$groupes->id),'Supprimer','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
		...
		<?php echo anchor(site_url('groupes/excel'), 'Excel', 'class="btn btn-primary"'); ?>
		<?php echo anchor(site_url('groupes/word'), 'Word', 'class="btn btn-primary"'); ?>
	    </div>
